    ...
    public class SequenceSimilarity
    {
        ...
        public static List<Protein> TransferModifications(List<Protein> source, List<Protein> destination)
        {
            ...
            foreach (string seq in common_seqs)
            {
                ...
                new_proteins.Add(new Protein(seq, destination_protein.Accession, source_protein.OneBasedPossibleLocalizedModifications, source_protein.OneBasedBeginPositions, source_protein.OneBasedEndPositions, source_protein.BigPeptideTypes, destination_protein.Name, destination_protein.FullName, destination_protein.IsDecoy, destination_protein.IsContaminant, source_protein.GoTerms));
            }
